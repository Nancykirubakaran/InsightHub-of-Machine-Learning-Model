...
# Set autoreload to 2 (automatic reloading of modules)
#%autoreload 2

# Exclude specific modules causing issues with autoreload
#%aimport -prompt_toolkit.filters.base
#%aimport -prompt_toolkit.filters.app
#%aimport -IPython.core.magics.packaging
# Add similar lines for other modules causing issues
 ...
 #***********************************************************************************************************************************************           
    ...
    if opt == "EDA":
        ...
        if file.df is not None:
            ...
            train_lab = y[:split_index]
            test_lab = y[split_index:]
            ...
            st.write('Scaling data:', train_data_scaled)
            st.write('- Scaling process done using StandardScaler')
    ...
    if opt == "Prediction":
        ...
        with st.form("user_inputs"):
            with st.container():
                ...
                last_visitId = st.number_input("last_visitId")
...
#***********************************************************************************************************************************************
    ...
    train_data1, test_data1 = train_test_split(data_for_sur,test_size=0.2)
    model = SVD()
